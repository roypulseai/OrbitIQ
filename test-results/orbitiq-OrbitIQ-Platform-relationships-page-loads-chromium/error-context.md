...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> relationships page loads
- Location: e2e\orbitiq.spec.ts:36:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/relationships", waiting until "load"
