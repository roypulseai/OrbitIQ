...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> models page loads
- Location: e2e\orbitiq.spec.ts:26:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/models", waiting until "load"
