...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> PII detection page loads
- Location: e2e\orbitiq.spec.ts:106:7
...
Locator: locator('text=PII')
Expected: visible
Error: strict mode violation: locator('text=PII') resolved to 5 elements:
    1) <span>PII Detection</span> aka getByRole('link', { name: 'PII Detection' })
    2) <h1 class="text-2xl font-bold text-white">PII Detection & Tagging</h1> aka getByRole('heading', { name: 'PII Detection & Tagging' })
    3) <span class="text-sm text-surface-6">PII Detected</span> aka getByText('PII Detected')
    4) <h3 class="text-sm font-semibold text-white mb-3">PII Types</h3> aka getByRole('heading', { name: 'PII Types' })
    5) <th class="text-left px-4 py-3 text-xs font-semibold text-surface-6 uppercase">PII Type</th> aka getByRole('columnheader', { name: 'PII Type' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=PII')
    ...
    - generic [ref=e267]:
      ...
      - main [ref=e295]:
        - generic [ref=e296]:
          - generic [ref=e297]:
            - generic [ref=e298]:
              - heading "PII Detection & Tagging" [level=1] [ref=e299]
              - paragraph [ref=e300]: Auto-scan columns for personally identifiable information
            - button "Run Scan" [ref=e301] [cursor=pointer]:
              - img [ref=e302]
              - text: Run Scan
          - generic [ref=e304]:
            - generic [ref=e305]:
              - generic [ref=e306]:
                - generic [ref=e307]: Columns Scanned
                - img [ref=e308]
              - generic [ref=e315]: "42"
            - generic [ref=e316]:
              - generic [ref=e317]:
                - generic [ref=e318]: PII Detected
                - img [ref=e319]
              - generic [ref=e321]: "6"
            - generic [ref=e322]:
              - generic [ref=e323]:
                - generic [ref=e324]: Avg Confidence
                - img [ref=e325]
              - generic [ref=e327]: 93%
          - generic [ref=e328]:
            - heading "PII Types" [level=3] [ref=e329]
            - generic [ref=e330]:
              - generic [ref=e331]: Email addresses
              - generic [ref=e332]: Phone numbers
              - generic [ref=e333]: Personal names
              - generic [ref=e334]: Social Security Numbers
              - generic [ref=e335]: Payment card numbers
              - generic [ref=e336]: IP addresses
              - generic [ref=e337]: Physical addresses
              - generic [ref=e338]: Dates of birth
          - table [ref=e340]:
            - rowgroup [ref=e341]:
              - row "Column Table PII Type Confidence Source Masking Actions" [ref=e342]:
                - columnheader "Column" [ref=e343]
                - columnheader "Table" [ref=e344]
                - columnheader "PII Type" [ref=e345]
                - columnheader "Confidence" [ref=e346]
                - columnheader "Source" [ref=e347]
                - columnheader "Masking" [ref=e348]
                - columnheader "Actions" [ref=e349]
            - rowgroup [ref=e350]:
              - row "email Customers email 98% regex Full Mask" [ref=e351]:
                - cell "email" [ref=e352]
                - cell "Customers" [ref=e353]
                - cell "email" [ref=e354]:
                  - generic [ref=e355]: email
                - cell "98%" [ref=e356]:
                  - generic [ref=e360]: 98%
                - cell "regex" [ref=e361]:
                  - generic [ref=e362]: regex
                - cell "Full Mask" [ref=e363]
                - cell [ref=e364]:
                  - generic [ref=e365]:
                    ...
                    - button [ref=e370] [cursor=pointer]:
                      - img [ref=e371]
              - row "phone Customers phone 92% regex Partial Mask" [ref=e374]:
                - cell "phone" [ref=e375]
                - cell "Customers" [ref=e376]
                - cell "phone" [ref=e377]:
                  - generic [ref=e378]: phone
                - cell "92%" [ref=e379]:
                  - generic [ref=e383]: 92%
                - cell "regex" [ref=e384]:
                  - generic [ref=e385]: regex
                - cell "Partial Mask" [ref=e386]
                - cell [ref=e387]:
                  - generic [ref=e388]:
                    ...
                    - button [ref=e393] [cursor=pointer]:
                      - img [ref=e394]
              - row "first_name Employees name 85% classifier Full Mask" [ref=e397]:
                - cell "first_name" [ref=e398]
                - cell "Employees" [ref=e399]
                - cell "name" [ref=e400]:
                  - generic [ref=e401]: name
                - cell "85%" [ref=e402]:
                  - generic [ref=e406]: 85%
                - cell "classifier" [ref=e407]:
                  - generic [ref=e408]: classifier
                - cell "Full Mask" [ref=e409]
                - cell [ref=e410]:
                  - generic [ref=e411]:
                    ...
                    - button [ref=e416] [cursor=pointer]:
                      - img [ref=e417]
              - row "ssn Employees ssn 99% regex Full Mask" [ref=e420]:
                - cell "ssn" [ref=e421]
                - cell "Employees" [ref=e422]
                - cell "ssn" [ref=e423]:
                  - generic [ref=e424]: ssn
                - cell "99%" [ref=e425]:
                  - generic [ref=e429]: 99%
                - cell "regex" [ref=e430]:
                  - generic [ref=e431]: regex
                - cell "Full Mask" [ref=e432]
                - cell [ref=e433]:
                  - generic [ref=e434]:
                    ...
                    - button [ref=e439] [cursor=pointer]:
                      - img [ref=e440]
              - row "ip_address Access Logs ip_address 88% regex Hash" [ref=e443]:
                - cell "ip_address" [ref=e444]
                - cell "Access Logs" [ref=e445]
                - cell "ip_address" [ref=e446]:
                  - generic [ref=e447]: ip_address
                - cell "88%" [ref=e448]:
                  - generic [ref=e452]: 88%
                - cell "regex" [ref=e453]:
                  - generic [ref=e454]: regex
                - cell "Hash" [ref=e455]
                - cell [ref=e456]:
                  - generic [ref=e457]:
                    ...
                    - button [ref=e462] [cursor=pointer]:
                      - img [ref=e463]
              - row "credit_card Transactions credit_card 97% regex Full Mask" [ref=e466]:
                - cell "credit_card" [ref=e467]
                - cell "Transactions" [ref=e468]
                - cell "credit_card" [ref=e469]:
                  - generic [ref=e470]: credit_card
                - cell "97%" [ref=e471]:
                  - generic [ref=e475]: 97%
                - cell "regex" [ref=e476]:
                  - generic [ref=e477]: regex
                - cell "Full Mask" [ref=e478]
                - cell [ref=e479]:
                  - generic [ref=e480]:
                    ...
                    - button [ref=e485] [cursor=pointer]:
                      - img [ref=e486]
          - generic [ref=e489]:
            - heading "Scan Configuration" [level=3] [ref=e490]
            - generic [ref=e491]:
              - generic [ref=e492]:
                - generic [ref=e493]: Model
                - combobox [ref=e494]:
                  - option "Sales Analytics" [selected]
              - generic [ref=e495]:
                - generic [ref=e496]: Table
                - combobox [ref=e497]:
            ...
            - generic [ref=e498]:
              - generic [ref=e499] [cursor=pointer]:
                - checkbox "Include sample values" [checked] [ref=e500]
                - text: Include sample values
              - generic [ref=e501] [cursor=pointer]:
                - checkbox "Auto-create masking rules" [checked] [ref=e502]
                - text: Auto-create masking rules
  - alert [ref=e503]
```
