...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> explore page loads
- Location: e2e\orbitiq.spec.ts:21:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/explore", waiting until "load"
