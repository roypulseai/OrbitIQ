...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> RLS page loads
- Location: e2e\orbitiq.spec.ts:96:7
...
Locator: locator('text=Security')
Expected: visible
Error: strict mode violation: locator('text=Security') resolved to 4 elements:
    1) <div class="px-3 py-1 text-[11px] font-semibold text-surface-6 uppercase tracking-wider">Security & Governance</div> aka getByText('Security & Governance')
    2) <span>Row-Level Security</span> aka getByRole('link', { name: 'Row-Level Security' })
    3) <span>Column Security</span> aka getByRole('link', { name: 'Column Security' })
    4) <h1 class="text-2xl font-bold text-white tracking-tight flex items-center gap-3">…</h1> aka getByRole('heading', { name: 'Row-Level Security' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Security')
    ...
    - generic [ref=e267]:
      ...
      - main [ref=e295]:
        - generic [ref=e296]:
          - generic [ref=e297]:
            - generic [ref=e298]:
              - heading "Row-Level Security" [level=1] [ref=e299]:
                - img [ref=e300]
                - text: Row-Level Security
              - paragraph [ref=e302]: Manage data access policies that filter rows based on user attributes
            - generic [ref=e303]:
              - img [ref=e304]
              - text: 4 active policies
          - generic [ref=e307]:
            - generic [ref=e309]:
              - img [ref=e311]
              - generic [ref=e313]:
                - generic [ref=e314]: "5"
                - generic [ref=e315]: Total Policies
            - generic [ref=e317]:
              - img [ref=e319]
              - generic [ref=e322]:
                - generic [ref=e323]: "4"
                - generic [ref=e324]: Active Policies
            - generic [ref=e326]:
              - img [ref=e328]
              - generic [ref=e332]:
                - generic [ref=e333]: "5"
                - generic [ref=e334]: Tables Covered
            - generic [ref=e336]:
              - img [ref=e338]
              - generic [ref=e343]:
                - generic [ref=e344]: "4"
                - generic [ref=e345]: Users with Attributes
          - generic [ref=e346]:
            - generic [ref=e347]:
              - heading "Policies" [level=2] [ref=e348]:
                - img [ref=e349]
                - text: Policies
              - button "Create Policy" [ref=e351] [cursor=pointer]:
                - img [ref=e352]
                - text: Create Policy
            - table [ref=e354]:
              - rowgroup [ref=e355]:
                - row "Policy Name Table Expression Applies To Status Priority Actions" [ref=e356]:
                  - columnheader "Policy Name" [ref=e357]
                  - columnheader "Table" [ref=e358]
                  - columnheader "Expression" [ref=e359]
                  - columnheader "Applies To" [ref=e360]
                  - columnheader "Status" [ref=e361]
                  - columnheader "Priority" [ref=e362]
                  - columnheader "Actions" [ref=e363]
              - rowgroup [ref=e364]:
                - row "Region Filter Sales USERATTRIBUTE(\"region\") = \"US\" admin viewer Active 10" [ref=e365]:
                  - cell "Region Filter" [ref=e366]
                  - cell "Sales" [ref=e367]:
                    - generic [ref=e368]:
                      - img [ref=e369]
                      - text: Sales
                  - cell "USERATTRIBUTE(\"region\") = \"US\"" [ref=e373]:
                    - code [ref=e374]: USERATTRIBUTE("region") = "US"
                  - cell "admin viewer" [ref=e375]:
                    - generic [ref=e376]:
                      - generic [ref=e377]: admin
                      - generic [ref=e378]: viewer
                  - cell "Active" [ref=e379]:
                    - button "Active" [ref=e380] [cursor=pointer]: Active
                  - cell "10" [ref=e382]
                  - cell [ref=e383]:
                    - generic [ref=e384]:
                      ...
                      - button "Delete" [ref=e389] [cursor=pointer]:
                        - img [ref=e390]
                - row "Department Restriction Employee USERATTRIBUTE(\"department\") IN (\"Engineering\", \"Data\") editor Active 20" [ref=e393]:
                  - cell "Department Restriction" [ref=e394]
                  - cell "Employee" [ref=e395]:
                    - generic [ref=e396]:
                      - img [ref=e397]
                      - text: Employee
                  - cell "USERATTRIBUTE(\"department\") IN (\"Engineering\", \"Data\")" [ref=e401]:
                    - code [ref=e402]: USERATTRIBUTE("department") IN ("Engineering", "Data")
                  - cell "editor" [ref=e403]:
                    - generic [ref=e405]: editor
                  - cell "Active" [ref=e406]:
                    - button "Active" [ref=e407] [cursor=pointer]: Active
                  - cell "20" [ref=e409]
                  - cell [ref=e410]:
                    - generic [ref=e411]:
                      ...
                      - button "Delete" [ref=e416] [cursor=pointer]:
                        - img [ref=e417]
                - row "Cost Center Guard Financials USERATTRIBUTE(\"cost_center\") = \"CC001\" viewer Inactive 30" [ref=e420]:
                  - cell "Cost Center Guard" [ref=e421]
                  - cell "Financials" [ref=e422]:
                    - generic [ref=e423]:
                      - img [ref=e424]
                      - text: Financials
                  - cell "USERATTRIBUTE(\"cost_center\") = \"CC001\"" [ref=e428]:
                    - code [ref=e429]: USERATTRIBUTE("cost_center") = "CC001"
                  - cell "viewer" [ref=e430]:
                    - generic [ref=e432]: viewer
                  - cell "Inactive" [ref=e433]:
                    - button "Inactive" [ref=e434] [cursor=pointer]: Inactive
                  - cell "30" [ref=e436]
                  - cell [ref=e437]:
                    - generic [ref=e438]:
                      ...
                      - button "Delete" [ref=e443] [cursor=pointer]:
                        - img [ref=e444]
                - row "Manager Hierarchy Reports USERATTRIBUTE(\"role\") = \"admin\" OR USERATTRIBUTE(\"reports_to\") = CURRENT_USER() admin editor Active 5" [ref=e447]:
                  - cell "Manager Hierarchy" [ref=e448]
                  - cell "Reports" [ref=e449]:
                    - generic [ref=e450]:
                      - img [ref=e451]
                      - text: Reports
                  - cell "USERATTRIBUTE(\"role\") = \"admin\" OR USERATTRIBUTE(\"reports_to\") = CURRENT_USER()" [ref=e455]:
                    - code [ref=e456]: USERATTRIBUTE("role") = "admin" OR USERATTRIBUTE("reports_to") = CURRENT_USER()
                  - cell "admin editor" [ref=e457]:
                    - generic [ref=e458]:
                      - generic [ref=e459]: admin
                      - generic [ref=e460]: editor
                  - cell "Active" [ref=e461]:
                    - button "Active" [ref=e462] [cursor=pointer]: Active
                  - cell "5" [ref=e464]
                  - cell [ref=e465]:
                    - generic [ref=e466]:
                      ...
                      - button "Delete" [ref=e471] [cursor=pointer]:
                        - img [ref=e472]
                - row "Global Admin Bypass All tables USERATTRIBUTE(\"role\") = \"GlobalAdmin\" admin Active 1" [ref=e475]:
                  - cell "Global Admin Bypass" [ref=e476]
                  - cell "All tables" [ref=e477]:
                    - generic [ref=e478]:
                      - img [ref=e479]
                      - text: All tables
                  - cell "USERATTRIBUTE(\"role\") = \"GlobalAdmin\"" [ref=e483]:
                    - code [ref=e484]: USERATTRIBUTE("role") = "GlobalAdmin"
                  - cell "admin" [ref=e485]:
                    - generic [ref=e487]: admin
                  - cell "Active" [ref=e488]:
                    - button "Active" [ref=e489] [cursor=pointer]: Active
                  - cell "1" [ref=e491]
                  - cell [ref=e492]:
                    - generic [ref=e493]:
                      ...
                      - button "Delete" [ref=e498] [cursor=pointer]:
                        - img [ref=e499]
          - generic [ref=e502]:
            - heading "Expression Tester" [level=2] [ref=e503]:
              - img [ref=e504]
              - text: Expression Tester
            - generic [ref=e506]:
              - generic [ref=e507]:
                - generic [ref=e508]: OQL Expression
                - textbox "USERATTRIBUTE(\"region\") = \"US\"" [ref=e509]
              - generic [ref=e510]:
                - generic [ref=e511]: User Attributes
                - generic [ref=e512]:
                  - generic [ref=e513]:
                    - textbox "key" [ref=e514]: region
                    - textbox "value" [ref=e515]: US
                    - button [ref=e516] [cursor=pointer]:
                      - img [ref=e517]
                  - generic [ref=e520]:
                    - textbox "key" [ref=e521]: department
                    - textbox "value" [ref=e522]: Engineering
                    - button [ref=e523] [cursor=pointer]:
                      - img [ref=e524]
                  - button "+ Add attribute" [ref=e527] [cursor=pointer]
            - button "Evaluate" [ref=e529] [cursor=pointer]:
              - img [ref=e530]
              - text: Evaluate
  - alert [ref=e532]
```
