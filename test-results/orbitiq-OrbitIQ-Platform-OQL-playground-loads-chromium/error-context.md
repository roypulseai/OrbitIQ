...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> OQL playground loads
- Location: e2e\orbitiq.spec.ts:41:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/oql", waiting until "load"
...
- generic [ref=e2]:
  ...
  - generic [ref=e267]:
    ...
    - main [ref=e291]:
      - generic [ref=e292]:
        - generic [ref=e294]:
          - heading "OQL Playground" [level=1] [ref=e295]
          - paragraph [ref=e296]: Write OQL or SQL queries and see results instantly.
        - generic [ref=e297]:
          - generic [ref=e299]:
            - generic [ref=e300]:
              - generic [ref=e301]:
                - generic [ref=e302]: Query
                - generic [ref=e303]: OQL v1
              - generic [ref=e304]:
                - button "Example 1" [ref=e305] [cursor=pointer]
                - button "Example 2" [ref=e306] [cursor=pointer]
                - button "Example 3" [ref=e307] [cursor=pointer]
            - textbox "Type your OQL query here..." [ref=e308]: SELECT * FROM sales WHERE region = 'North America' LIMIT 10;
            - generic [ref=e309]:
              - generic [ref=e310]: 60 chars
              - button "Run Query" [ref=e311] [cursor=pointer]:
                - img [ref=e312]
                - text: Run Query
          - generic [ref=e315]:
            - img [ref=e316]
            - heading "Run a query to see results" [level=3] [ref=e319]
            - paragraph [ref=e320]: Write OQL or SQL in the editor, then click Run. Results appear here.
```
