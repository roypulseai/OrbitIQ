...
- Name: orbitiq.spec.ts >> OrbitIQ Platform >> connections page loads
- Location: e2e\orbitiq.spec.ts:31:7
...
Call log:
  - navigating to "http://localhost:3001/dashboard/connections", waiting until "load"
